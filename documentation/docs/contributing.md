...
- **Report bugs**: If you find a bug, report it on [GitHub Issues](https://github.com/tsyche/NotablyMD/issues/new/choose)
- **Suggest features**: Have an idea for a new feature? Share it on [GitHub Issues](https://github.com/tsyche/NotablyMD/issues/new/choose)
...
1. **Fork the repository**: Go to [NotablyMD on GitHub](https://github.com/tsyche/NotablyMD) and click the "Fork" button
2. **Clone your fork**: 
   ```bash
...
1. Download the current [translations.xlsx](https://github.com/tsyche/NotablyMD/raw/refs/heads/main/app/translations.xlsx) file
...
3. Open an [Update Translations Issue](https://github.com/tsyche/NotablyMD/issues/new?assignees=&labels=translations&projects=&template=translation.md&title=%3CINSERT+LANGUAGE+HERE%3E+translations+update)

...
NotablyMD provides several features to help keep your notes secure and private. This guide explains how to use note locking, biometric authentication to protect your data.


## Note Locking

<img src={require('/img/phoneScreenshots/8.png').default} width="32%" alt="Security Features in NotablyMD"/>
...
5. Whenever your device was locked, NotablyMD will be locked too and require authentication to see the notes

## Auto-Backup

NotablyMD can automatically back up your notes to prevent data loss.
...
NotablyMD stores all your notes locally on your device. Your data is not uploaded to any cloud service unless you explicitly use a cloud storage service to back up your notes.


### Permissions

NotablyMD requires minimal permissions to function:
...
NotablyMD does not collect any personal data or usage statistics. Your notes remain private on your device.
...
- [Settings](./settings.mdx): Learn about ways to customize NotablyMD

...
NotablyMD provides several features to help backing up your data.
...
3. After adding your mount, you can go back into NotablyMD and setup the backup folder, you will now see your WebDAV in the file chooser and can pick any folder on it:
<img src={require('/img/webdav.png').default} width="32%" alt="WebDAV in File Chooser" />

#### Synchronization
Instead of mounting your Cloud-Storage/WebDAV you can also use apps like [FolderSync](https://play.google.com/store/apps/details?id=dk.tacit.android.foldersync.lite&hl=en) to sync a folder on your device with other devices and simply set NotablyMD's backup folder to that synched folder.

...
NotablyMD provides task list functionality to help you manage your to-dos, shopping lists, project tasks, and more. This guide explains how to create and manage task lists effectively.

<img src={require('/img/phoneScreenshots/2.png').default} width="32%" alt="Task Lists in NotablyMD"/>
...
By default, NotablyMD automatically sorts your task lists by moving checked items to the bottom. You can customize this behavior:
...
NotablyMD provides several options for managing multiple tasks at once.

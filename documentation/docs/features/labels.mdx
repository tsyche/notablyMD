...
NotablyMD offers several tools to help you organize your notes and find them quickly when you need them. This guide explains how to use labels, colors, pinning, and sorting to keep your notes organized.

<img src={require('/img/phoneScreenshots/4.png').default} width="32%" alt="Labels and Organization in NotablyMD" />
...
- [Settings](../settings.mdx): Learn about other ways to customize NotablyMD

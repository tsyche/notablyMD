...
/**
 * Comprehensive UI Test Suite for Voice Recording Features
 * Runs all UI tests to verify voice recording functionality works in emulator
 * 
 * This suite tests:
 ...
 * 
 * Note: Physical button combinations (Power+Volume Up) cannot be tested in emulator
 * but all other voice recording triggers should work
 */
@RunWith(Suite::class)
@Suite.SuiteClasses(

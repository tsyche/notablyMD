...
/**
 * UI tests for Widget Configuration and functionality Tests widget customization options and
 * configuration UI
 */
...
class WidgetConfigurationUITest {
    ...
    @get:Rule val activityRule = ActivityScenarioRule(ConfigureWidgetActivity::class.java)
    ...
    fun widgetCustomizationOptionsShouldBePresent() {
        ...
        try {
            ...
            onView(withText("Enable advanced widget customization options"))
    ...
    fun widgetStatusIndicatorOptionShouldBePresent() {
        ...
        try {
            ...
            onView(withText("Show recording status indicator on widget"))
                .check(matches(isDisplayed()))
        } catch (e: Exception) {
            // Option might have different text
    ...
    fun widgetBehaviorOptionShouldBePresent() {
        ...
        try {
            ...
            onView(withText("Choose what happens when you tap the widget"))
                .check(matches(isDisplayed()))
        } catch (e: Exception) {
            // Option might have different text

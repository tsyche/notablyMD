...
import com.tsyche.notablymd.BuildConfig
...
import com.tsyche.notablymd.databinding.DialogErrorBinding
...
fun Context.createReportBugIntent(
    ...
    val url =
        "https://github.com/tsyche/NotablyMD/issues/new?labels=bug&projects=&template=bug_report.yml${

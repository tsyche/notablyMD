...
import com.tsyche.notablymd.data.model.toHtml
import com.tsyche.notablymd.data.model.toJson
import com.tsyche.notablymd.data.model.toMarkdown
import com.tsyche.notablymd.data.model.toTxt
...
import com.tsyche.notablymd.presentation.activity.main.fragment.settings.SettingsFragment
import com.tsyche.notablymd.presentation.view.misc.Progress
import com.tsyche.notablymd.presentation.viewmodel.BackupFile
...
import com.tsyche.notablymd.presentation.viewmodel.progress.BackupProgress
import com.tsyche.notablymd.utils.MIME_TYPE_ZIP
import com.tsyche.notablymd.utils.SUBFOLDER_AUDIOS
import com.tsyche.notablymd.utils.SUBFOLDER_FILES
import com.tsyche.notablymd.utils.SUBFOLDER_IMAGES
import com.tsyche.notablymd.utils.ZipVerificationException
import com.tsyche.notablymd.utils.copyToLarge
import com.tsyche.notablymd.utils.createChannelIfNotExists
import com.tsyche.notablymd.utils.createFileSafe
import com.tsyche.notablymd.utils.createReportBugIntent
import com.tsyche.notablymd.utils.getCurrentAudioDirectory
import com.tsyche.notablymd.utils.getCurrentFilesDirectory
import com.tsyche.notablymd.utils.getCurrentImagesDirectory
import com.tsyche.notablymd.utils.getCurrentMediaRoot
import com.tsyche.notablymd.utils.getExportedPath
import com.tsyche.notablymd.utils.getLogFileUri
import com.tsyche.notablymd.utils.listZipFiles
import com.tsyche.notablymd.utils.log
import com.tsyche.notablymd.utils.md5Hash
import com.tsyche.notablymd.utils.recreateDir
import com.tsyche.notablymd.utils.resolveAttachmentFile
import com.tsyche.notablymd.utils.security.decryptDatabase
import com.tsyche.notablymd.utils.security.getInitializedCipherForDecryption
import com.tsyche.notablymd.utils.verify
...
const val AUTO_BACKUP_WORK_NAME = "com.tsyche.notablymd.AutoBackupWork"

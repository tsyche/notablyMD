...
public class SQLCipherUtils {
     ...
     * on whether we can open it without a passphrase.
     * <p>
     * NOTE: You are responsible for ensuring that
     ...
     *
     * @param ctxt       a Context
     * @param dbName     the name of the database, as used with Room,
     *                   SQLiteOpenHelper,
     *                   etc.
    ...
    public static void decrypt(Context ctxt, File originalFile, File decryptedFile, byte[] passphrase)
            throws IOException {
        System.loadLibrary("sqlcipher");

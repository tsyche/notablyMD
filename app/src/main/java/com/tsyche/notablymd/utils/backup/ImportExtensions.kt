...
import com.tsyche.notablymd.data.imports.ImportStage
...
import com.tsyche.notablymd.data.model.parseToColorString
import com.tsyche.notablymd.presentation.getQuantityString
import com.tsyche.notablymd.presentation.showToast
import com.tsyche.notablymd.presentation.viewmodel.NotallyModel.FileType
...
import com.tsyche.notablymd.utils.clearDirectory
import com.tsyche.notablymd.utils.copyToFile
import com.tsyche.notablymd.utils.determineMimeTypeAndExtension
...
import com.tsyche.notablymd.utils.mimeTypeToFileExtension
import com.tsyche.notablymd.utils.rename
import com.tsyche.notablymd.utils.scheduleNoteReminders
import com.tsyche.notablymd.utils.security.SQLCipherUtils
        ...
        try {
            ...
            val cursor =
                sourceDb.rawQuery(
                    ...
                    arrayOf(
                        com.tsyche.notablymd.data.dao.BaseNoteDao.Companion.MAX_BODY_CHAR_LENGTH
                            .toString(),
                        id.toString(),
                    ),
                )

...
import com.tsyche.notablymd.presentation.view.note.listitem.findChildrenPositions
import com.tsyche.notablymd.presentation.view.note.listitem.findParentPosition
...
import com.tsyche.notablymd.utils.embedIntentExtras
import com.tsyche.notablymd.utils.getOpenNotePendingIntent
import com.tsyche.notablymd.utils.isSystemInDarkMode
...
class WidgetProvider : AppWidgetProvider() {
    ...
    companion object {
        ...
        private const val EXTRA_MODIFIED_NOTES = "com.tsyche.notablymd.EXTRA_MODIFIED_NOTES"
        private const val ACTION_NOTES_MODIFIED = "com.tsyche.notablymd.ACTION_NOTE_MODIFIED"

        const val ACTION_OPEN_NOTE = "com.tsyche.notablymd.ACTION_OPEN_NOTE"
        const val ACTION_OPEN_LIST = "com.tsyche.notablymd.ACTION_OPEN_LIST"
        const val ACTION_SELECT_NOTE = "com.tsyche.notablymd.ACTION_SELECT_NOTE"

        const val ACTION_CHECKED_CHANGED = "com.tsyche.notablymd.ACTION_CHECKED_CHANGED"
        const val EXTRA_POSITION = "notablymd.intent.extra.com.tsyche.notablymd.EXTRA_POSITION"
    }
}

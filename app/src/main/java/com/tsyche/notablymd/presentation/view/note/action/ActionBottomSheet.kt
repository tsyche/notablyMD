package com.tsyche.notablymd.presentation.view.note.action
...
import com.tsyche.notablymd.databinding.BottomSheetActionBinding
...
open class ActionBottomSheet(
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        val dialog =
            BottomSheetDialog(
                requireContext(),
                com.tsyche.notablymd.R.style.ThemeOverlay_App_BottomSheetDialog,
            )
        color?.let {
            dialog.window?.apply {

...
import com.tsyche.notablymd.data.NotallyDatabase.Companion.DATABASE_NAME
import com.tsyche.notablymd.data.dao.BaseNoteDao
import com.tsyche.notablymd.data.dao.CommonDao
import com.tsyche.notablymd.data.dao.LabelDao
import com.tsyche.notablymd.data.dao.NoteReminder
import com.tsyche.notablymd.data.imports.ImportException
import com.tsyche.notablymd.data.imports.ImportProgress
import com.tsyche.notablymd.data.imports.ImportSource
import com.tsyche.notablymd.data.imports.NotesImporter
import com.tsyche.notablymd.data.model.Attachment
import com.tsyche.notablymd.data.model.Audio
import com.tsyche.notablymd.data.model.BaseNote
import com.tsyche.notablymd.data.model.Content
import com.tsyche.notablymd.data.model.Converters
...
import com.tsyche.notablymd.data.model.Label
import com.tsyche.notablymd.data.model.SearchResult
import com.tsyche.notablymd.data.model.deepCopy
import com.tsyche.notablymd.data.model.toNoteIdReminders
import com.tsyche.notablymd.presentation.activity.main.fragment.settings.SettingsFragment.Companion.EXTRA_SHOW_IMPORT_BACKUPS_FOLDER
import com.tsyche.notablymd.presentation.getQuantityString
import com.tsyche.notablymd.presentation.restartApplication
import com.tsyche.notablymd.presentation.setCancelButton
import com.tsyche.notablymd.presentation.showSnackbar
...
import com.tsyche.notablymd.presentation.viewmodel.preference.BasePreference
...
import com.tsyche.notablymd.presentation.viewmodel.preference.NotablyMDPreferences.Companion.START_VIEW_DEFAULT
import com.tsyche.notablymd.presentation.viewmodel.preference.NotablyMDPreferences.Companion.START_VIEW_UNLABELED
import com.tsyche.notablymd.presentation.viewmodel.preference.Theme
import com.tsyche.notablymd.presentation.viewmodel.progress.DeleteProgress
import com.tsyche.notablymd.presentation.viewmodel.progress.ExportNotesProgress
import com.tsyche.notablymd.utils.ActionMode
import com.tsyche.notablymd.utils.Cache
import com.tsyche.notablymd.utils.MIME_TYPE_JSON
import com.tsyche.notablymd.utils.backup.clearAllFolders
import com.tsyche.notablymd.utils.backup.clearAllLabels
import com.tsyche.notablymd.utils.backup.copyDatabase
import com.tsyche.notablymd.utils.backup.exportAsZip
import com.tsyche.notablymd.utils.backup.exportPdfFile
import com.tsyche.notablymd.utils.backup.exportPdfFileFolder
import com.tsyche.notablymd.utils.backup.exportPlainTextFile
import com.tsyche.notablymd.utils.backup.exportPlainTextFileFolder
import com.tsyche.notablymd.utils.backup.getPreviousLabels
import com.tsyche.notablymd.utils.backup.getPreviousNotes
import com.tsyche.notablymd.utils.backup.importZip
import com.tsyche.notablymd.utils.backup.readAsBackup
import com.tsyche.notablymd.utils.cancelNoteReminders
import com.tsyche.notablymd.utils.copyToLarge
import com.tsyche.notablymd.utils.deleteAttachments
import com.tsyche.notablymd.utils.getBackupDir
...
import com.tsyche.notablymd.utils.security.decryptDatabase
import com.tsyche.notablymd.utils.security.encryptDatabase
import com.tsyche.notablymd.utils.security.isEncryptedDatabase
import com.tsyche.notablymd.utils.security.isUnencryptedDatabase
import com.tsyche.notablymd.utils.toReadablePath
import com.tsyche.notablymd.utils.viewFile
import java.io.File

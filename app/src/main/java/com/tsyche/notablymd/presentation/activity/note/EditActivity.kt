package com.tsyche.notablymd.presentation.activity.note
...
import com.tsyche.notablymd.data.dao.BaseNoteDao.Companion.MAX_BODY_CHAR_LENGTH
...
import com.tsyche.notablymd.data.model.isImageMimeType
import com.tsyche.notablymd.databinding.ActivityEditBinding
...
import com.tsyche.notablymd.presentation.activity.main.MainActivity.Companion.EXTRA_FRAGMENT_TO_OPEN
import com.tsyche.notablymd.presentation.activity.main.MainActivity.Companion.EXTRA_SKIP_START_VIEW_ON_BACK
import com.tsyche.notablymd.presentation.activity.main.fragment.DisplayLabelFragment.Companion.EXTRA_DISPLAYED_LABEL
import com.tsyche.notablymd.presentation.activity.note.SelectLabelsActivity.Companion.EXTRA_SELECTED_LABELS
import com.tsyche.notablymd.presentation.activity.note.reminders.RemindersActivity
import com.tsyche.notablymd.presentation.add
import com.tsyche.notablymd.presentation.addFastScroll
import com.tsyche.notablymd.presentation.addIconButton
import com.tsyche.notablymd.presentation.bindLabels
import com.tsyche.notablymd.presentation.displayEditLabelDialog
import com.tsyche.notablymd.presentation.displayFormattedTimestamp
import com.tsyche.notablymd.presentation.extractColor
import com.tsyche.notablymd.presentation.getQuantityString
import com.tsyche.notablymd.presentation.hideKeyboard
import com.tsyche.notablymd.presentation.isLightColor
...
import com.tsyche.notablymd.presentation.setLightStatusAndNavBar
...
import com.tsyche.notablymd.presentation.view.note.ErrorAdapter
import com.tsyche.notablymd.presentation.view.note.action.Action
import com.tsyche.notablymd.presentation.view.note.action.AddActions
import com.tsyche.notablymd.presentation.view.note.action.AddBottomSheet
import com.tsyche.notablymd.presentation.view.note.action.MoreActions
import com.tsyche.notablymd.presentation.view.note.action.MoreNoteBottomSheet
import com.tsyche.notablymd.presentation.view.note.audio.AudioAdapter
import com.tsyche.notablymd.presentation.view.note.preview.PreviewFileAdapter
import com.tsyche.notablymd.presentation.view.note.preview.PreviewImageAdapter
import com.tsyche.notablymd.presentation.viewmodel.ExportMimeType
import com.tsyche.notablymd.presentation.viewmodel.NotallyModel
import com.tsyche.notablymd.presentation.viewmodel.preference.DateFormat
import com.tsyche.notablymd.presentation.viewmodel.preference.ListItemSort
import com.tsyche.notablymd.presentation.viewmodel.preference.NotesSortBy
import com.tsyche.notablymd.presentation.widget.WidgetProvider
import com.tsyche.notablymd.utils.FileError
import com.tsyche.notablymd.utils.backup.exportNote
import com.tsyche.notablymd.utils.changeStatusAndNavigationBarColor
import com.tsyche.notablymd.utils.changehistory.ChangeHistory
import com.tsyche.notablymd.utils.getFileName
import com.tsyche.notablymd.utils.getMimeType
import com.tsyche.notablymd.utils.getUriForFile
import com.tsyche.notablymd.utils.log
import com.tsyche.notablymd.utils.mergeSkipFirst
import com.tsyche.notablymd.utils.observeSkipFirst
import com.tsyche.notablymd.utils.openNote
import com.tsyche.notablymd.utils.shareNote
import com.tsyche.notablymd.utils.showColorSelectDialog
import com.tsyche.notablymd.utils.textMaxLengthFilter
import com.tsyche.notablymd.utils.wrapWithChooser
import java.io.File

...
import com.tsyche.notablymd.data.imports.evernote.EvernoteImporter
import com.tsyche.notablymd.data.imports.google.GoogleKeepImporter
import com.tsyche.notablymd.data.imports.txt.JsonImporter
import com.tsyche.notablymd.data.imports.txt.PlainTextImporter
...
class NotesImporter(private val app: Application, private val database: NotallyDatabase) {
    ...
    private fun findDuplicateId(note: com.tsyche.notablymd.data.model.BaseNote): Long? {
        val dao = database.getBaseNoteDao()
    ...
    private fun normalizeContent(note: com.tsyche.notablymd.data.model.BaseNote): String {

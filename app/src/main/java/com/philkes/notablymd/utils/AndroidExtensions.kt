...
import com.philkes.notablymd.BuildConfig
...
import com.philkes.notablymd.databinding.DialogErrorBinding
...
fun Context.createReportBugIntent(
    ...
    val url =
        "https://github.com/Crustack/NotablyMD/issues/new?labels=bug&projects=&template=bug_report.yml${

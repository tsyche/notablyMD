...
import com.philkes.notablymd.data.imports.ImportStage
...
import com.philkes.notablymd.data.model.parseToColorString
import com.philkes.notablymd.presentation.getQuantityString
import com.philkes.notablymd.presentation.showToast
import com.philkes.notablymd.presentation.viewmodel.NotallyModel.FileType
...
import com.philkes.notablymd.utils.clearDirectory
import com.philkes.notablymd.utils.copyToFile
import com.philkes.notablymd.utils.determineMimeTypeAndExtension
...
import com.philkes.notablymd.utils.mimeTypeToFileExtension
import com.philkes.notablymd.utils.rename
import com.philkes.notablymd.utils.scheduleNoteReminders
import com.philkes.notablymd.utils.security.SQLCipherUtils
            ...
            withContext(Dispatchers.IO) {
                ...
                if (state == SQLCipherUtils.State.ENCRYPTED) {
                    val fallbackEncryptionKey =
                        NotablyMDPreferences.getInstance(this@importZip)
        ...
        try {
            ...
            val cursor =
                sourceDb.rawQuery(
                    ...
                    arrayOf(
                        com.philkes.notablymd.data.dao.BaseNoteDao.Companion.MAX_BODY_CHAR_LENGTH
                            .toString(),
                        id.toString(),
                    ),
                )

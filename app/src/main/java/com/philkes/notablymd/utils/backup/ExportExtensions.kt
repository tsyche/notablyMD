...
import com.philkes.notablymd.data.model.toHtml
import com.philkes.notablymd.data.model.toJson
import com.philkes.notablymd.data.model.toMarkdown
import com.philkes.notablymd.data.model.toTxt
...
import com.philkes.notablymd.presentation.activity.main.fragment.settings.SettingsFragment
import com.philkes.notablymd.presentation.view.misc.Progress
import com.philkes.notablymd.presentation.viewmodel.BackupFile
...
import com.philkes.notablymd.presentation.viewmodel.progress.BackupProgress
import com.philkes.notablymd.utils.MIME_TYPE_ZIP
import com.philkes.notablymd.utils.SUBFOLDER_AUDIOS
import com.philkes.notablymd.utils.SUBFOLDER_FILES
import com.philkes.notablymd.utils.SUBFOLDER_IMAGES
import com.philkes.notablymd.utils.ZipVerificationException
import com.philkes.notablymd.utils.copyToLarge
import com.philkes.notablymd.utils.createChannelIfNotExists
import com.philkes.notablymd.utils.createFileSafe
import com.philkes.notablymd.utils.createReportBugIntent
import com.philkes.notablymd.utils.getCurrentAudioDirectory
import com.philkes.notablymd.utils.getCurrentFilesDirectory
import com.philkes.notablymd.utils.getCurrentImagesDirectory
import com.philkes.notablymd.utils.getCurrentMediaRoot
import com.philkes.notablymd.utils.getExportedPath
import com.philkes.notablymd.utils.getLogFileUri
import com.philkes.notablymd.utils.listZipFiles
import com.philkes.notablymd.utils.log
import com.philkes.notablymd.utils.md5Hash
import com.philkes.notablymd.utils.recreateDir
import com.philkes.notablymd.utils.resolveAttachmentFile
import com.philkes.notablymd.utils.security.decryptDatabase
import com.philkes.notablymd.utils.security.getInitializedCipherForDecryption
import com.philkes.notablymd.utils.verify
...
const val AUTO_BACKUP_WORK_NAME = "com.philkes.notablymd.AutoBackupWork"
...
private const val ON_SAVE_BACKUP_FILE = "NotablyMD_AutoBackup"
private const val PERIODIC_BACKUP_FILE_PREFIX = "NotablyMD_Backup_"
...
fun exportPdfFile(
    ...
    val html =
        note.toHtml(
            NotablyMDPreferences.getInstance(app).showDateCreated(),
...
fun Context.exportPreferences(preferences: NotablyMDPreferences, uri: Uri): Boolean {
    try {
        ...
        getSystemService<NotificationManager>()?.let { manager ->
            ...
            val bugIntent =
                try {
                    ...
                    createReportBugIntent(
                        stackTrace =
                            "PLEASE PASTE YOUR NOTABLYMD LOGS FILE CONTENT HERE (Error Notification -> 'View Logs')",
                        title = "Auto Backup failed",
                        body = "Error occurred during auto backup, see logs below.",
                    )
                }

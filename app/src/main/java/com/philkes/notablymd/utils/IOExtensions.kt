...
import com.philkes.notablymd.data.model.isImage
...
import com.philkes.notablymd.presentation.viewmodel.progress.DeleteAttachmentProgress
...
private fun ContextWrapper.isDataInPublicEnabled(): Boolean {
    return NotablyMDPreferences.getInstance(this).dataInPublicFolder.value
}
...
const val APP_LOG_FILE_NAME = "notablymd-logs"

...
import com.philkes.notablymd.databinding.ActivityLabelBinding
...
import com.philkes.notablymd.presentation.view.main.label.SelectableLabelAdapter
...
class SelectLabelsActivity : LockedActivity<ActivityLabelBinding>() {
    ...
    companion object {
        const val EXTRA_SELECTED_LABELS = "notablymd.intent.extra.SELECTED_LABELS"
    }
}

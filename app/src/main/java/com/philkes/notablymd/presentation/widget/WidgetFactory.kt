...
import com.philkes.notablymd.data.model.BaseNote.Companion.COLOR_DEFAULT
...
import com.philkes.notablymd.presentation.widget.WidgetProvider.Companion.extractWidgetColors
import com.philkes.notablymd.presentation.widget.WidgetProvider.Companion.getWidgetCheckedChangeIntent
import com.philkes.notablymd.presentation.widget.WidgetProvider.Companion.getWidgetOpenNoteIntent
import com.philkes.notablymd.presentation.widget.WidgetProvider.Companion.getWidgetSelectNoteIntent

class WidgetFactory(
    private val app: NotablyMDApplication,
    private val id: Long,
    ...
    private val preferences = NotablyMDPreferences.getInstance(app)

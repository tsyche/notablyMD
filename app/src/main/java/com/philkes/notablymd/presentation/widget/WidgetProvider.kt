package com.philkes.notablymd.presentation.widget
...
import com.philkes.notablymd.presentation.activity.ConfigureWidgetActivity
...
import com.philkes.notablymd.presentation.getContrastFontColor
import com.philkes.notablymd.presentation.view.note.listitem.findChildrenPositions
import com.philkes.notablymd.presentation.view.note.listitem.findParentPosition
...
import com.philkes.notablymd.utils.embedIntentExtras
import com.philkes.notablymd.utils.getOpenNotePendingIntent
import com.philkes.notablymd.utils.isSystemInDarkMode
...
class WidgetProvider : AppWidgetProvider() {
    ...
    override fun onReceive(context: Context, intent: Intent) {
        ...
        when (intent.action) {
            ...
            Intent.ACTION_LOCALE_CHANGED -> {
                val app = context.applicationContext as NotablyMDApplication
    ...
    companion object {
        ...
        private const val EXTRA_MODIFIED_NOTES = "com.philkes.notablymd.EXTRA_MODIFIED_NOTES"
        private const val ACTION_NOTES_MODIFIED = "com.philkes.notablymd.ACTION_NOTE_MODIFIED"

        const val ACTION_OPEN_NOTE = "com.philkes.notablymd.ACTION_OPEN_NOTE"
        const val ACTION_OPEN_LIST = "com.philkes.notablymd.ACTION_OPEN_LIST"
        const val ACTION_SELECT_NOTE = "com.philkes.notablymd.ACTION_SELECT_NOTE"

        const val ACTION_CHECKED_CHANGED = "com.philkes.notablymd.ACTION_CHECKED_CHANGED"
        const val EXTRA_POSITION = "notablymd.intent.extra.com.philkes.notablymd.EXTRA_POSITION"
    }
}

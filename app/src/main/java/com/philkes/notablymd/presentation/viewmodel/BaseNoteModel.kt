package com.philkes.notablymd.presentation.viewmodel
...
import com.philkes.notablymd.data.NotallyDatabase
import com.philkes.notablymd.data.NotallyDatabase.Companion.DATABASE_NAME
import com.philkes.notablymd.data.dao.BaseNoteDao
import com.philkes.notablymd.data.dao.CommonDao
import com.philkes.notablymd.data.dao.LabelDao
import com.philkes.notablymd.data.dao.NoteReminder
import com.philkes.notablymd.data.imports.ImportException
import com.philkes.notablymd.data.imports.ImportProgress
import com.philkes.notablymd.data.imports.ImportSource
import com.philkes.notablymd.data.imports.NotesImporter
import com.philkes.notablymd.data.model.Attachment
import com.philkes.notablymd.data.model.Audio
import com.philkes.notablymd.data.model.BaseNote
import com.philkes.notablymd.data.model.Content
import com.philkes.notablymd.data.model.Converters
import com.philkes.notablymd.data.model.FileAttachment
import com.philkes.notablymd.data.model.Folder
import com.philkes.notablymd.data.model.Header
import com.philkes.notablymd.data.model.Item
import com.philkes.notablymd.data.model.Label
import com.philkes.notablymd.data.model.SearchResult
import com.philkes.notablymd.data.model.deepCopy
import com.philkes.notablymd.data.model.toNoteIdReminders
import com.philkes.notablymd.presentation.activity.main.fragment.settings.SettingsFragment.Companion.EXTRA_SHOW_IMPORT_BACKUPS_FOLDER
import com.philkes.notablymd.presentation.getQuantityString
import com.philkes.notablymd.presentation.restartApplication
import com.philkes.notablymd.presentation.setCancelButton
import com.philkes.notablymd.presentation.showSnackbar
import com.philkes.notablymd.presentation.showToast
import com.philkes.notablymd.presentation.view.misc.NotNullLiveData
import com.philkes.notablymd.presentation.view.misc.Progress
import com.philkes.notablymd.presentation.viewmodel.preference.BasePreference
import com.philkes.notablymd.presentation.viewmodel.preference.BiometricLock
import com.philkes.notablymd.presentation.viewmodel.preference.NotablyMDPreferences
import com.philkes.notablymd.presentation.viewmodel.preference.NotablyMDPreferences.Companion.EMPTY_PATH
import com.philkes.notablymd.presentation.viewmodel.preference.NotablyMDPreferences.Companion.START_VIEW_DEFAULT
import com.philkes.notablymd.presentation.viewmodel.preference.NotablyMDPreferences.Companion.START_VIEW_UNLABELED
import com.philkes.notablymd.presentation.viewmodel.preference.Theme
import com.philkes.notablymd.presentation.viewmodel.progress.DeleteProgress
import com.philkes.notablymd.presentation.viewmodel.progress.ExportNotesProgress
import com.philkes.notablymd.utils.ActionMode
import com.philkes.notablymd.utils.Cache
import com.philkes.notablymd.utils.MIME_TYPE_JSON
import com.philkes.notablymd.utils.backup.clearAllFolders
import com.philkes.notablymd.utils.backup.clearAllLabels
import com.philkes.notablymd.utils.backup.copyDatabase
import com.philkes.notablymd.utils.backup.exportAsZip
import com.philkes.notablymd.utils.backup.exportPdfFile
import com.philkes.notablymd.utils.backup.exportPdfFileFolder
import com.philkes.notablymd.utils.backup.exportPlainTextFile
import com.philkes.notablymd.utils.backup.exportPlainTextFileFolder
import com.philkes.notablymd.utils.backup.getPreviousLabels
import com.philkes.notablymd.utils.backup.getPreviousNotes
import com.philkes.notablymd.utils.backup.importZip
import com.philkes.notablymd.utils.backup.readAsBackup
import com.philkes.notablymd.utils.cancelNoteReminders
import com.philkes.notablymd.utils.copyToLarge
import com.philkes.notablymd.utils.deleteAttachments
import com.philkes.notablymd.utils.getBackupDir
import com.philkes.notablymd.utils.getCurrentImagesDirectory
import com.philkes.notablymd.utils.getExternalMediaDirectory
import com.philkes.notablymd.utils.log
import com.philkes.notablymd.utils.migrateAllAttachments
import com.philkes.notablymd.utils.scheduleNoteReminders
import com.philkes.notablymd.utils.security.DecryptionException
import com.philkes.notablymd.utils.security.EncryptionException
import com.philkes.notablymd.utils.security.decryptDatabase
import com.philkes.notablymd.utils.security.encryptDatabase
import com.philkes.notablymd.utils.security.isEncryptedDatabase
import com.philkes.notablymd.utils.security.isUnencryptedDatabase
import com.philkes.notablymd.utils.toReadablePath
import com.philkes.notablymd.utils.viewFile
import java.io.File

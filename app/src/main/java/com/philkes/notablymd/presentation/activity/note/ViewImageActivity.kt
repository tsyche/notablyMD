...
import com.philkes.notablymd.databinding.ActivityViewImageBinding
...
import com.philkes.notablymd.presentation.view.note.image.ImageAdapter
...
class ViewImageActivity : LockedActivity<ActivityViewImageBinding>() {
            ...
            val intent =
                Intent(Intent.ACTION_CREATE_DOCUMENT)
                    .apply {
                        ...
                        putExtra(Intent.EXTRA_TITLE, "NotablyMD Image")
                    }
    ...
    companion object {
        const val EXTRA_POSITION = "notablymd.intent.extra.POSITION"
        const val CURRENT_IMAGE = "CURRENT_IMAGE"
        const val EXTRA_DELETED_IMAGES = "notablymd.intent.extra.DELETED_IMAGES"
    }
}

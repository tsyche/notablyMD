...
import com.philkes.notablymd.databinding.ActivityPickNoteBinding
...
open class PickNoteActivity : LockedActivity<ActivityPickNoteBinding>(), ItemListener {
    ...
    companion object {
        const val EXTRA_EXCLUDE_NOTE_ID = "notablymd.intent.extra.EXCLUDE_NOTE_ID"

        const val EXTRA_PICKED_NOTE_ID = "notablymd.intent.extra.PICKED_NOTE_ID"
        const val EXTRA_PICKED_NOTE_TITLE = "notablymd.intent.extra.PICKED_NOTE_TITLE"
        const val EXTRA_PICKED_NOTE_TYPE = "notablymd.intent.extra.PICKED_NOTE_TYPE"
    }
}

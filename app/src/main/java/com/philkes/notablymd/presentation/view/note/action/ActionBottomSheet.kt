package com.philkes.notablymd.presentation.view.note.action
...
import com.philkes.notablymd.databinding.BottomSheetActionBinding
import com.philkes.notablymd.presentation.dp
import com.philkes.notablymd.presentation.getColorFromAttr
...
open class ActionBottomSheet(
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        val dialog =
            BottomSheetDialog(
                requireContext(),
                com.philkes.notablymd.R.style.ThemeOverlay_App_BottomSheetDialog,
            )
        color?.let {
            dialog.window?.apply {

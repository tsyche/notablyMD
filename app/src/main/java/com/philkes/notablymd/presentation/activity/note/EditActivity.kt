package com.philkes.notablymd.presentation.activity.note
...
import com.philkes.notablymd.data.dao.BaseNoteDao.Companion.MAX_BODY_CHAR_LENGTH
...
import com.philkes.notablymd.data.model.NoteViewMode
import com.philkes.notablymd.data.model.Type
import com.philkes.notablymd.data.model.isImageMimeType
import com.philkes.notablymd.databinding.ActivityEditBinding
import com.philkes.notablymd.presentation.activity.LockedActivity
import com.philkes.notablymd.presentation.activity.main.MainActivity
import com.philkes.notablymd.presentation.activity.main.MainActivity.Companion.EXTRA_FRAGMENT_TO_OPEN
import com.philkes.notablymd.presentation.activity.main.MainActivity.Companion.EXTRA_SKIP_START_VIEW_ON_BACK
import com.philkes.notablymd.presentation.activity.main.fragment.DisplayLabelFragment.Companion.EXTRA_DISPLAYED_LABEL
import com.philkes.notablymd.presentation.activity.note.SelectLabelsActivity.Companion.EXTRA_SELECTED_LABELS
import com.philkes.notablymd.presentation.activity.note.reminders.RemindersActivity
import com.philkes.notablymd.presentation.add
import com.philkes.notablymd.presentation.addFastScroll
import com.philkes.notablymd.presentation.addIconButton
import com.philkes.notablymd.presentation.bindLabels
import com.philkes.notablymd.presentation.displayEditLabelDialog
import com.philkes.notablymd.presentation.displayFormattedTimestamp
import com.philkes.notablymd.presentation.extractColor
import com.philkes.notablymd.presentation.getQuantityString
import com.philkes.notablymd.presentation.hideKeyboard
import com.philkes.notablymd.presentation.isLightColor
...
import com.philkes.notablymd.presentation.setLightStatusAndNavBar
import com.philkes.notablymd.presentation.setupProgressDialog
import com.philkes.notablymd.presentation.showKeyboard
import com.philkes.notablymd.presentation.showToast
import com.philkes.notablymd.presentation.view.misc.NotNullLiveData
import com.philkes.notablymd.presentation.view.note.ErrorAdapter
import com.philkes.notablymd.presentation.view.note.action.Action
import com.philkes.notablymd.presentation.view.note.action.AddActions
import com.philkes.notablymd.presentation.view.note.action.AddBottomSheet
import com.philkes.notablymd.presentation.view.note.action.MoreActions
import com.philkes.notablymd.presentation.view.note.action.MoreNoteBottomSheet
import com.philkes.notablymd.presentation.view.note.audio.AudioAdapter
import com.philkes.notablymd.presentation.view.note.preview.PreviewFileAdapter
import com.philkes.notablymd.presentation.view.note.preview.PreviewImageAdapter
import com.philkes.notablymd.presentation.viewmodel.ExportMimeType
import com.philkes.notablymd.presentation.viewmodel.NotallyModel
import com.philkes.notablymd.presentation.viewmodel.preference.DateFormat
import com.philkes.notablymd.presentation.viewmodel.preference.ListItemSort
import com.philkes.notablymd.presentation.viewmodel.preference.NotesSortBy
import com.philkes.notablymd.presentation.widget.WidgetProvider
import com.philkes.notablymd.utils.FileError
import com.philkes.notablymd.utils.backup.exportNote
import com.philkes.notablymd.utils.changeStatusAndNavigationBarColor
import com.philkes.notablymd.utils.changehistory.ChangeHistory
import com.philkes.notablymd.utils.getFileName
import com.philkes.notablymd.utils.getMimeType
import com.philkes.notablymd.utils.getUriForFile
import com.philkes.notablymd.utils.log
import com.philkes.notablymd.utils.mergeSkipFirst
import com.philkes.notablymd.utils.observeSkipFirst
import com.philkes.notablymd.utils.openNote
import com.philkes.notablymd.utils.shareNote
import com.philkes.notablymd.utils.showColorSelectDialog
import com.philkes.notablymd.utils.textMaxLengthFilter
import com.philkes.notablymd.utils.wrapWithChooser
import java.io.File
...
abstract class EditActivity(private val type: Type) :
    ...
    companion object {
        ...
        const val EXTRA_SELECTED_BASE_NOTE = "notablymd.intent.extra.SELECTED_BASE_NOTE"
        const val EXTRA_NOTE_ID = "notablymd.intent.extra.NOTE_ID"
        const val EXTRA_FOLDER_FROM = "notablymd.intent.extra.FOLDER_FROM"
        const val EXTRA_FOLDER_TO = "notablymd.intent.extra.FOLDER_TO"
        const val EXTRA_INITIAL_SEARCH_QUERY = "notablymd.intent.extra.INITIAL_SEARCH_QUERY"

package com.philkes.notablymd.presentation.activity.main
...
import com.philkes.notablymd.databinding.ActivityMainBinding
...
import com.philkes.notablymd.presentation.activity.main.fragment.NotablyMDFragment
import com.philkes.notablymd.presentation.activity.main.fragment.SearchFragment
import com.philkes.notablymd.presentation.activity.note.EditListActivity
import com.philkes.notablymd.presentation.activity.note.EditNoteActivity
import com.philkes.notablymd.presentation.add
import com.philkes.notablymd.presentation.dp
import com.philkes.notablymd.presentation.getQuantityString
import com.philkes.notablymd.presentation.movedToResId
...
import com.philkes.notablymd.presentation.view.misc.tristatecheckbox.TriStateCheckBox
import com.philkes.notablymd.presentation.view.misc.tristatecheckbox.setMultiChoiceTriStateItems
import com.philkes.notablymd.presentation.viewmodel.BaseNoteModel
import com.philkes.notablymd.presentation.viewmodel.BaseNoteModel.Companion.CURRENT_LABEL_EMPTY
import com.philkes.notablymd.presentation.viewmodel.BaseNoteModel.Companion.CURRENT_LABEL_NONE
...
import com.philkes.notablymd.presentation.viewmodel.progress.MigrationProgress
import com.philkes.notablymd.utils.LATEST_DATA_SCHEMA
import com.philkes.notablymd.utils.backup.exportNotes
import com.philkes.notablymd.utils.runMigrations
...
class MainActivity : LockedActivity<ActivityMainBinding>() {
    ...
    private fun prepareNewNoteIntent(intent: Intent): Intent {
        return supportFragmentManager
            ...
            ?.firstOrNull()
            ?.let { fragment ->
                return if (fragment is NotablyMDFragment) {
        ...
        return when (item.itemId) {
            ACTION_SEARCH -> {
                ...
                if (isInSearchFragment) {
                    ...
                    if (currentFragment is NotablyMDFragment) {
    ...
    companion object {
        const val EXTRA_FRAGMENT_TO_OPEN = "notablymd.intent.extra.FRAGMENT_TO_OPEN"
        const val EXTRA_SKIP_START_VIEW_ON_BACK = "notablymd.intent.extra.SKIP_START_VIEW_ON_BACK"

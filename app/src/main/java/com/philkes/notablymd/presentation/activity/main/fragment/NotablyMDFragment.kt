...
import com.philkes.notablymd.databinding.FragmentNotesBinding
import com.philkes.notablymd.presentation.activity.main.MainActivity
import com.philkes.notablymd.presentation.activity.main.fragment.SearchFragment.Companion.EXTRA_INITIAL_FOLDER
import com.philkes.notablymd.presentation.activity.main.fragment.SearchFragment.Companion.EXTRA_INITIAL_LABEL
import com.philkes.notablymd.presentation.activity.note.EditActivity
import com.philkes.notablymd.presentation.activity.note.EditActivity.Companion.EXTRA_FOLDER_FROM
import com.philkes.notablymd.presentation.activity.note.EditActivity.Companion.EXTRA_FOLDER_TO
import com.philkes.notablymd.presentation.activity.note.EditActivity.Companion.EXTRA_NOTE_ID
import com.philkes.notablymd.presentation.activity.note.EditActivity.Companion.EXTRA_SELECTED_BASE_NOTE
...
import com.philkes.notablymd.presentation.view.main.BaseNoteAdapter
import com.philkes.notablymd.presentation.view.main.BaseNoteVHPreferences
import com.philkes.notablymd.presentation.view.misc.ItemListener
import com.philkes.notablymd.presentation.viewmodel.BaseNoteModel
import com.philkes.notablymd.presentation.viewmodel.preference.NotesView

abstract class NotablyMDFragment : Fragment(), ItemListener {
    ...
    private fun setupSearch() {
        binding?.EnterSearchKeyword?.apply {
            ...
            doAfterTextChanged { text ->
                ...
                this@NotablyMDFragment.binding?.MainListView?.apply {
    ...
    companion object {
        private const val EXTRA_SCROLL_POS = "notablymd.intent.extra.SCROLL_POS"
        private const val EXTRA_SCROLL_OFFSET = "notablymd.intent.extra.SCROLL_OFFSET"
    }
}

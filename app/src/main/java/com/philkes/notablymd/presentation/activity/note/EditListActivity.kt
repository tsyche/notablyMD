...
import com.philkes.notablymd.presentation.hideKeyboardOnFocusedItem
import com.philkes.notablymd.presentation.setOnNextAction
import com.philkes.notablymd.presentation.showKeyboardOnFocusedItem
import com.philkes.notablymd.presentation.view.note.action.MoreListActions
import com.philkes.notablymd.presentation.view.note.action.MoreListBottomSheet
import com.philkes.notablymd.presentation.view.note.listitem.HighlightText
import com.philkes.notablymd.presentation.view.note.listitem.ListManager
import com.philkes.notablymd.presentation.view.note.listitem.adapter.CheckedListItemAdapter
import com.philkes.notablymd.presentation.view.note.listitem.adapter.ListItemAdapter
import com.philkes.notablymd.presentation.view.note.listitem.adapter.ListItemHighlight
import com.philkes.notablymd.presentation.view.note.listitem.adapter.ListItemVH
import com.philkes.notablymd.presentation.view.note.listitem.init
import com.philkes.notablymd.presentation.view.note.listitem.setItems
import com.philkes.notablymd.presentation.view.note.listitem.sorting.ListItemParentSortCallback
import com.philkes.notablymd.presentation.view.note.listitem.sorting.SortedItemsList
import com.philkes.notablymd.presentation.view.note.listitem.splitByChecked
import com.philkes.notablymd.presentation.view.note.listitem.toMutableList
import com.philkes.notablymd.presentation.viewmodel.preference.NotablyMDPreferences
import com.philkes.notablymd.presentation.viewmodel.preference.autoSortByCheckedEnabled
import com.philkes.notablymd.utils.findAllOccurrences
import com.philkes.notablymd.utils.indices
import com.philkes.notablymd.utils.mapIndexed
...
class EditListActivity : EditActivity(Type.LIST), MoreListActions {
    ...
    override fun setStateFromModel(savedInstanceState: Bundle?) {
        ...
        adapter =
            ListItemAdapter(
                ...
                elevation,
                NotablyMDPreferences.getInstance(application),
                listManager,
                false,
                binding.ScrollView,
            )
    ...
    companion object {
        private const val EXTRA_ITEM_POS = "notablymd.intent.extra.ITEM_POS"
        private const val EXTRA_SELECTION_START = "notablymd.intent.extra.EXTRA_SELECTION_START"
        private const val EXTRA_SELECTION_END = "notablymd.intent.extra.EXTRA_SELECTION_END"
    }
}

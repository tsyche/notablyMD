...
import com.philkes.notablymd.databinding.ActivityPlayAudioBinding
...
import com.philkes.notablymd.utils.audio.AudioPlayService
import com.philkes.notablymd.utils.audio.LocalBinder
...
class PlayAudioActivity : LockedActivity<ActivityPlayAudioBinding>() {
    ...
    companion object {
        const val EXTRA_AUDIO = "notablymd.intent.extra.AUDIO"
    }
}

...
import com.philkes.notablymd.data.imports.evernote.EvernoteImporter
import com.philkes.notablymd.data.imports.google.GoogleKeepImporter
import com.philkes.notablymd.data.imports.txt.JsonImporter
import com.philkes.notablymd.data.imports.txt.PlainTextImporter
...
class NotesImporter(private val app: Application, private val database: NotallyDatabase) {
    ...
    private fun findDuplicateId(note: com.philkes.notablymd.data.model.BaseNote): Long? {
        val dao = database.getBaseNoteDao()
    ...
    private fun normalizeContent(note: com.philkes.notablymd.data.model.BaseNote): String {

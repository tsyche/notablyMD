package com.philkes.notablymd.data
...
import com.philkes.notablymd.data.model.Color
...
import com.philkes.notablymd.data.model.toColorString
...
import com.philkes.notablymd.presentation.viewmodel.preference.observeForeverSkipFirst
...
abstract class NotallyDatabase : RoomDatabase() {
    ...
    companion object {
        ...
        fun getCurrentDatabaseFile(context: ContextWrapper): File {
            return if (NotablyMDPreferences.getInstance(context).dataInPublicFolder.value) {
        ...
        fun getFreshDatabase(context: ContextWrapper, dataInPublic: Boolean): NotallyDatabase {
            return createInstance(
                context,
                NotablyMDPreferences.getInstance(context),
                false,
